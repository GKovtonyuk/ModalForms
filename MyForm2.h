...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(82, 143);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(143, 55);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Відкрити форму 3";
			...
			this->label1->Size = System::Drawing::Size(268, 60);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Немодальні форми (Show())\r\n дозволяють взаємодіяти\r\n з іншими вікнами.";
			// 
			// MyForm2
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(318, 272);
